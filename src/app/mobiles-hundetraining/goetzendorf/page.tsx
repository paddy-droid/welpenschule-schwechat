...
const mobileTrainingPillars = [
  ...
  { icon: <Users className="text-yellow-500" />, title: "Flexible Terminvereinbarung", description: "Kein Stress, keine Anfahrt. Wir richten uns nach deinem Zeitplan und kommen zu dir nach Götzendorf." },
...
export default function MobileHundetrainingGoetzendorfPage() {
  return (
    <div>
      <section className="relative h-[70vh] flex items-center justify-center text-white">
        <Image
          src="https://www.willenskraft.co.at/wp-content/uploads/2020/06/DSC09452-845x684.jpg"
          alt="Mobiles Hundetraining in Götzendorf an der Leitha"
          fill
        ...
        <div className="relative z-20 text-center p-6 md:p-8 bg-black/20 rounded-lg shadow-lg max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-extrabold drop-shadow-lg">
            Mobiles Hundetraining in <span className="text-yellow-400">Götzendorf</span> an der Leitha
          </h1>
          <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
            Ganzheitliches & gewaltfreies Hundetraining – flexibel bei dir zuhause oder an deinem Wunschort in Götzendorf.
          </p>
          <Button asChild size="lg" className="mt-8 bg-yellow-500 hover:bg-yellow-600 text-black font-bold">
            <Link href="/kontakt?service=mobiles-training-goetzendorf">Jetzt mobiles Training anfragen</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Du wünschst dir individuelles Hundetraining in Götzendorf, das sich nach dir richtet?</h2>
          <p className="text-lg text-gray-700">
            Du möchtest an spezifischen Themen arbeiten, hast einen vollen Terminkalender oder dein Hund fühlt sich in einer Gruppe nicht wohl? Dann ist unser mobiles Hundetraining in Götzendorf an der Leitha die perfekte Lösung. Wir kommen zu dir nach Hause und gestalten das Training ganz nach deinen Bedürfnissen.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <Image
                src="https://www.willenskraft.co.at/wp-content/uploads/2020/06/DSC09452-845x684.jpg"
                alt="Hund und Besitzerin trainieren zuhause in Götzendorf"
                width={600}
                height={600}
          ...
          <div className="text-center max-w-3xl mx-auto mb-4">
            <Button asChild variant="outline" className="mb-8">
              <Link href="/mobiles-hundetraining">
                ...
                Zurück zum mobilen Hundetraining
              </Link>
            </Button>
          </div>
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold mb-4">Die 5 Vorteile des mobilen Hundetrainings</h2>
            <p className="text-lg text-gray-700">Flexibel, individuell und effektiv – entdecke, warum sich das Training bei dir zuhause in Götzendorf lohnt!</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-800">Dein Weg zum perfekten Mensch-Hund-Team in Götzendorf</h2>
          ...
          <div className="text-center mt-12">
            <div className="bg-yellow-400 rounded-2xl p-8 max-w-2xl mx-auto shadow-xl">
              ...
              <p className="text-gray-700 mb-6">Gemeinsam finden wir den richtigen Weg für dich und deinen Hund in Götzendorf</p>
              <Button asChild size="lg" className="bg-gray-800 hover:bg-gray-900 text-white font-bold shadow-lg">
                <Link href="/kontakt?service=mobiles-training-goetzendorf">Jetzt Training anfragen</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      <WillenskraftSection content={getLocationConfig('goetzendorf')} />
      ...
      <SeoRegionSection region="Götzendorf an der Leitha" />
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="bg-white p-8 rounded-lg shadow-2xl flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto">
          ...
          <div className="w-full md:w-2/3 text-center md:text-left">
            <h2 className="text-3xl font-bold mb-4">Interesse am mobilen Training in Götzendorf?</h2>
            ...
            <Button asChild size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold">
              <Link href="/kontakt?service=mobiles-training-goetzendorf">Jetzt anfragen</Link>
            </Button>
            <div className="mt-6">
