...
const pillars = [
  { icon: <Heart className="text-yellow-500" />, title: "Individuelles Training in Ebenfurth", description: "Wir gehen gezielt auf deine Wünsche und die Bedürfnisse deines Hundes ein – für maximale Erfolge direkt in Ebenfurth." },
  { icon: <Zap className="text-yellow-500" />, title: "Training in gewohnter Umgebung", description: "Dein Hund lernt dort, wo das Gelernte am Ende sitzen muss: in seinem Alltag, bei dir zuhause in Ebenfurth." },
  { icon: <Users className="text-yellow-500" />, title: "Flexible Terminvereinbarung", description: "Kein Stress, keine Anfahrt. Wir richten uns nach deinem Zeitplan und kommen zu dir nach Ebenfurth." },
  { icon: <CheckCircle2 className="text-yellow-500" />, title: "Alltagsnahe Probleme lösen", description: "Ob Leinenführigkeit, Rückruf oder Begegnungen – wir arbeiten an konkreten Herausforderungen in Ebenfurth." },
  { icon: <Star className="text-yellow-500" />, title: "Stärkung der Bindung", description: "Durch das gemeinsame Training in vertrauter Atmosphäre in Ebenfurth wird die Beziehung zwischen dir und deinem Hund gefestigt." },
];

export default function EbenfurthMobileTrainingPage() {
  return (
    <div>
      {/* Hero Section */}
      <section className="relative h-[70vh] flex items-center justify-center text-white">
        <Image
          ...
          alt="Mobiles Hundetraining in Ebenfurth"
          fill
        ...
        <div className="relative z-20 text-center p-6 md:p-8 bg-black/20 rounded-lg shadow-lg max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-6xl font-extrabold drop-shadow-lg">
            Mobiles Hundetraining in <span className="text-yellow-400">Ebenfurth</span>
          </h1>
          <p className="mt-4 text-lg md:text-xl max-w-2xl mx-auto">
            Ganzheitliches & gewaltfreies Hundetraining – flexibel bei dir zuhause oder an deinem Wunschort in Ebenfurth.
          </p>
          <Button asChild size="lg" className="mt-8 bg-yellow-500 hover:bg-yellow-600 text-black font-bold">
            <Link href="/kontakt?service=mobiles-training-ebenfurth">Jetzt mobiles Training in Ebenfurth anfragen</Link>
          </Button>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl font-bold mb-4">Du wünschst dir individuelles Hundetraining in Ebenfurth, das sich nach dir richtet?</h2>
          <p className="text-lg text-gray-700">
            Du möchtest an spezifischen Themen arbeiten, hast einen vollen Terminkalender oder dein Hund fühlt sich in einer Gruppe nicht wohl? Dann ist unser mobiles Hundetraining in Ebenfurth die perfekte Lösung. Wir kommen zu dir nach Hause und gestalten das Training ganz nach deinen Bedürfnissen.
          </p>
        </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bold mb-4">Die 5 Vorteile des mobilen Hundetrainings in Ebenfurth</h2>
            <p className="text-lg text-gray-700">Flexibel, individuell und effektiv – entdecke, warum sich das Training bei dir zuhause in Ebenfurth lohnt!</p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-4xl font-bold mb-4 text-gray-800">Dein Weg zum perfekten Mensch-Hund-Team in Ebenfurth</h2>
            <p className="text-xl text-gray-600">Willenskraft Hundetraining - Wir begleiten dich und deinen Vierbeiner in Ebenfurth</p>
          </div>
          ...
          <div className="text-center mt-12">
            <div className="bg-yellow-400 rounded-2xl p-8 max-w-2xl mx-auto shadow-xl">
              <h3 className="text-2xl font-bold text-gray-800 mb-4">Bereit für die Veränderung in Ebenfurth?</h3>
              ...
              <Button asChild size="lg" className="bg-gray-800 hover:bg-gray-900 text-white font-bold shadow-lg">
                <Link href="/kontakt?service=mobiles-training-ebenfurth">Jetzt Training in Ebenfurth anfragen</Link>
              </Button>
            </div>
          </div>
        </div>
      ...
      {/* WillenskraftSection */}
      <WillenskraftSection content={getLocationConfig('ebenfurth')} />
      ...
      {/* SEO Region Section */}
      <SeoRegionSection region="Ebenfurth" />
        ...
        <div className="bg-white p-8 rounded-lg shadow-2xl flex flex-col md:flex-row items-center gap-8 max-w-4xl mx-auto">
          <div className="w-full md:w-1/3">
            <Image
              ...
              alt="Jessica Pusch - Hundeschule Willenskraft Ebenfurth"
              width={300}
              height={300}
          ...
          <div className="w-full md:w-2/3 text-center md:text-left">
            <h2 className="text-3xl font-bold mb-4">Interesse am mobilen Training in Ebenfurth?</h2>
            <p className="text-xl mb-6">Kontaktiere mich für ein unverbindliches Gespräch und wir finden die beste Lösung für dich und deinen Hund in Ebenfurth.</p>
            <Button asChild size="lg" className="bg-yellow-500 hover:bg-yellow-600 text-black font-bold">
              <Link href="/kontakt?service=mobiles-training-ebenfurth">Jetzt anfragen</Link>
            </Button>
            <div className="mt-6">
