        ...
        <div className="grid md:grid-cols-3 gap-8 text-center md:text-left mb-8">
            ...
            <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                    <Link href="/mobiles-hundetraining"><p className="hover:text-yellow-500">Schwechat</p></Link>
                    <Link href="/mobiles-hundetraining/fischamend"><p className="hover:text-yellow-500">Fischamend</p></Link>
                    <Link href="/mobiles-hundetraining/schwadorf"><p className="hover:text-yellow-500">Schwadorf</p></Link>
                    <Link href="/mobiles-hundetraining/ebenfurth"><p className="hover:text-yellow-500">Ebenfurth</p></Link>
                    <Link href="/mobiles-hundetraining/gramatneusiedl"><p className="hover:text-yellow-500">Gramatneusiedl</p></Link>
